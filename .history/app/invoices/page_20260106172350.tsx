          ...
          <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700 text-sm">
            <thead className="bg-gray-50 dark:bg-gray-700">
              <tr>
                ...
                <th className="hidden md:table-cell px-2 lg:px-3 py-2 text-right text-xs font-medium text-gray-700 dark:text-gray-300 uppercase tracking-wider">
                  الشركة
                </th>
                <th className="px-2 lg:px-3 py-2 text-right text-xs font-medium text-gray-700 dark:text-gray-300 uppercase tracking-wider">
                  المشروع
                ...
                <th className="px-2 lg:px-3 py-2 text-right text-xs font-medium text-gray-700 dark:text-gray-300 uppercase tracking-wider w-[40px]">
                  {/* Actions column */}
                </th>
              </tr>
            </thead>
            <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
              {filteredInvoices.length === 0 ? (
                <tr>
                  <td colSpan={7} className="px-2 lg:px-3 py-6 text-center text-gray-600 dark:text-gray-400 text-sm">
                    ...
                    <tr key={invoice.id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                      <td className="px-2 lg:px-3 py-2 whitespace-nowrap">
                        <div className="flex items-center gap-2">
                          <div className="flex h-7 w-7 items-center justify-center rounded bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 flex-shrink-0">
                      ...
                      <td className="hidden md:table-cell px-2 lg:px-3 py-2 whitespace-nowrap">
                        <p className="text-xs font-medium text-gray-900 dark:text-gray-100 truncate max-w-[150px]">
                      ...
                      <td className="px-2 lg:px-3 py-2">
                        <div>
                          ...
                          <p className="text-[10px] text-gray-600 dark:text-gray-400 truncate max-w-[120px]">
                            {invoice.building?.building_code || '-'}
                          </p>
                        </div>
                      </td>
                      <td className="px-2 lg:px-3 py-2 whitespace-nowrap">
                      ...
                      <td className="hidden lg:table-cell px-2 lg:px-3 py-2 whitespace-nowrap text-xs text-gray-700 dark:text-gray-400">
                        {formatDate(invoice.created_at, 'ar-SA')}
                      </td>
                      <td className="px-2 lg:px-3 py-2 whitespace-nowrap">
                        <Badge variant={status.variant}>{status.label}</Badge>
                      </td>
                      <td className="px-2 lg:px-3 py-2 whitespace-nowrap text-right">
                        <DropdownMenu
                          trigger={

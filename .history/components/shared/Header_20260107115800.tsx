    ...
    const getUser = async () => {
      ...
      if (user) {
        ...
        if (!error && profile) {
          ...
          setUserName(profileData.username || profileData.email || user.email || null)
          setUserEmail(profileData.email || user.email || null)

          // Translate role
          if (profileData.role === 'admin') {
            setUserRole('مدير نظام')
          } else {
            setUserRole(profileData.role || 'مدير نظام')
          }
        } else {
